          ...
          <div className="row">
            ...
            <div className="col-9">
              <div>
                ...
                <div>
                    <span className={`d-inline-flex mb-3 px-2 py-0 bg-${ticketAble?'success':'danger'}-subtle border border-${ticketAble?'success':'danger'}-subtle rounded-2`}> isTicketAble : {ticketAble?'Yes':'No'}</span>
                </div>
                <div>
